# fhir-ig-jp-specific-health-checkups
...
# 実装ガイドの特徴
特定健診の実装ガイドは[特定健診の電子的なデータ標準様式 特定健診情報ファイル仕様説明書 Version 3.1](https://www.mhlw.go.jp/content/12400000/000672493.pdf)に基づいて作成しています。

また、FHIRの構造定義だけではなく、容易にシステム化できるように特定健診とFHIRリソースのマッピング情報も提供しています。これらのマッピング情報は、各リソースのマッピング・タブよりご確認ください。
